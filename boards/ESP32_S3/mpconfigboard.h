...
#define MICROPY_HW_BOARD_NAME               "ESP32-S3 with pyDirect"
#endif
...
// Default I2C pins (can be overridden by runtime manifest)
#define MICROPY_HW_I2C0_SCL                 (9)
#define MICROPY_HW_I2C0_SDA                 (8)

// Default SPI pins (can be overridden by runtime manifest)
